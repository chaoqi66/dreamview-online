...
// import gridGround from 'assets/images/ground_gray.png';
// import gridGround from 'assets/images/ground_darkgray.png';
// import gridGround from 'assets/images/ten.png';
// import gridGround from 'assets/images/ten_center.png';
import gridGround from 'assets/images/ten_center_new.png';
  ...
  update(world, coordinates, scene) {
    ...
    if (this.mesh.type === 'grid') {
      ...
      if (STORE.options.showVirtualCloseLoop || STORE.options.showCloseLoop) {
        if (world.virtualCar && world.virtualCar.positionX && world.virtualCar.positionY) {
