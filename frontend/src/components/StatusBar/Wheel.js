...
export default class WheelPanel extends React.Component {
  render() {
    const { steeringPercentage, steeringAngle, steeringAngleRad, turnSignal } = this.props;
    ...
    return (
            <div className="wheel-panel">
                <div className='new-angle'>{steeringAngleRad}</div>
                <div className="angle-unit">&deg;</div>
