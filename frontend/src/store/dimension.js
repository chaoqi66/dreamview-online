...
const MONITOR_WIDTH_IN_PX = {
  ...
  [MONITOR_MENU.PREDICTION_MONITOR]: {
    small: 400,
    large: 450,
  },
  [MONITOR_MENU.EFFICIENT_MONITOR]: {
    small: 400,
    large: 450,
  },
  [MONITOR_MENU.PROPOSALS_MONITOR]: {
    small: 400,
    large: 450,
  },
...
export default class Dimension {
    ...
    @action updateMainDimension() {
      ...
      this.main.width = Math.max(MAIN_STYLE.MIN_MAIN_VIEW_WIDTH, this.pane.width);
    }
